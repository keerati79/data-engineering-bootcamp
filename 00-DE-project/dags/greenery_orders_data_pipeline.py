...
def _load_data_to_gcs(ds):
    keyfile_gcs = "/opt/airflow/dags/de-workshop-b17f97190dcc.json"
    ...
    bucket_name = "deb-bootcamp-100006"
...
def _load_data_from_gcs_to_bigquery(ds):
    ...
    blob = bucket.blob(destination_blob_name)
    if blob.exists():
        keyfile_bigquery = "/opt/airflow/dags/de-workshop-575ae22f9924.json"
        ...
        table_id = f"{PROJECT_ID}.de_workshop.{DATA}${partition}"
